...
* The app shall allow picture-taking of cars in all environments, with automobile detection even in night-time conditions (highways, day-light parking areas, underground parkings, roads, etc.) When the settings get too dark or the user is too close for easy recognition, the app can pop up messages to advise using flash or standing further/closer from the vehicle.
  
* It will most likely be directed towards young adults, as most car enthusiasts start developing curiosity for the topic at a young age. However, the user-friendliness of the app will allow the interface to be used by all types of users regardless of their age.
  
* The main screen will simply be a list of the 10 most recently saved cars, and the bottom of the page will visibly have the picture-taking icon. When the user takes the picture the AI will be triggered to gather and display the respective information about the vehicle.
  
* For protection reasons, the app will automatically blur the plate license of the vehicle. After the picture has been taken the user will be able to save the picture and its respective AI-generated data in its private car list.
  
* There will be a common gallery with pictures from all users who wish to share their findings; before sharing, users will be able to specify their preferences via picture filtering. 
...
* The Q&A page will allow users to ask their individual questions on the site, to be answered by AI or real-time users.
...
* Cars with external appearance modifications, such as special colors, spoilers or other components that may confuse the AI when determining the correct model.
...
For the demo example: https://en.wikipedia.org/wiki/Ferrari_488
https://www.ferrari.com/auto/ferrari-488-gtb
